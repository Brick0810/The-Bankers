...
<ul>
    ...
    <?php
        if(isset($_SESSION[userId])){
            echo "<li><a href='accountsView.php' class=button>Accounts</a></li>";
            echo "<li><a href='transactionsView.php' class=button>Transactions</a></li>";
            echo "<li><a href='transfersView.php' class=button>Transfers</a></li>";
